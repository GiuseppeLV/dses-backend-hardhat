...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    const svgcit1="<svg width=\"320\" height=\"130\" xmlns=\"http://www.w3.org/2000/svg\"><circle width=\"300\" height=\"100\" x=\"10\" y=\"10\" style=\"fill:rgb(0,0,255);stroke-width:3;stroke:red\" /><text x=\"50\" y=\"50\" font-family=\"Arial\" font-size=\"20\" fill=\"yellow\">"
    ...
    console.log("PTtest:", pollutionNft.address,"-", developmentChains.includes(network.name),"-",process.env.ETHERSCAN_API_KEY)
